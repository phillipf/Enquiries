...
packages <- c("readr", "dplyr", "plyr", "tidyr", "ggplot2", "stringr", "lubridate", "sqldf", "randomNames", "data.table", "devtools", "scales", "knitr", "xtable", "stringi", "shiny", "zoo", "pMineR", "edeaR")
...
```{r Success rate, include=FALSE, eval = TRUE}
...
```{r Recheck read success, include=FALSE, eval = TRUE}
